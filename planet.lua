...
Planet.__index = Planet
    ...
    local planetData = {
        ...
        superEarth = {0.5, 1, 12, {Iron = 20, Carbon = 10, Silicon = 40, Oxygen = 20, Nitrogen = 4, RareMetals = 2, Water = 2}},
        earth = {0.1, 1, 12, {Iron = 20, Carbon = 10, Silicon = 40, Oxygen = 20, Nitrogen = 4, RareMetals = 2, Water = 2}},
        subEarth = {0.04, 1.15, 12, {Iron = 20, Carbon = 10, Silicon = 40, Oxygen = 20, Nitrogen = 4, RareMetals = 2, Water = 2}},
