...
function love.load()
    ...
    table.insert(planets, Planet.new(middleX, middleY, 0.0012, 0.02 * au, 0.05, 0, "ferria", planets[4], "Moon"))
    table.insert(planets, Planet.new(middleX, middleY, 0.0015, 0.028 * au, 0, 0, "ferria", planets[7], "Io"))
    table.insert(planets, Planet.new(middleX, middleY, 0.0008, 0.045 * au, 0.01, 0, "ferria", planets[7], "Europa"))
    table.insert(planets, Planet.new(middleX, middleY, 0.0025, 0.072 * au, 0, 0, "ferria", planets[7], "Ganymede"))
    table.insert(planets, Planet.new(middleX, middleY, 0.0018, 0.13 * au, 0.01, 0, "ferria", planets[7], "Callisto"))
    table.insert(planets, Planet.new(middleX, middleY, 0.00063, 0.012 * au, 0.02, 0, "plutonia", planets[8], "Mimas")) -- Most moons after are innacurate
    table.insert(planets, Planet.new(middleX, middleY, 0.00018, 0.016 * au, 0, 0, "plutonia", planets[8], "Enceladus"))
    table.insert(planets, Planet.new(middleX, middleY, 0.0001, 0.02 * au, 0, 0, "plutonia", planets[8], "Tethys"))
    table.insert(planets, Planet.new(middleX, middleY, 0.00018, 0.025 * au, 0, 0, "plutonia", planets[8], "Dione"))
    table.insert(planets, Planet.new(middleX, middleY, 0.00039, 0.035 * au, 0, 0, "plutonia", planets[8], "Rhea"))
    table.insert(planets, Planet.new(middleX, middleY, 0.00225, 0.08 * au, 0.03, 0, "plutonia", planets[8], "Titan"))
    table.insert(planets, Planet.new(middleX, middleY, 0.0003, 0.23 * au, 0.03, 0, "plutonia", planets[8], "Iapetus"))
    table.insert(planets, Planet.new(middleX, middleY, 0.0001, 0.009 * au, 0, 0, "plutonia", planets[9], "Miranda"))
    table.insert(planets, Planet.new(middleX, middleY, 0.0002, 0.013 * au, 0, 0, "plutonia", planets[9], "Ariel"))
    table.insert(planets, Planet.new(middleX, middleY, 0.0002, 0.018 * au, 0, 0, "plutonia", planets[9], "Umbriel"))
    table.insert(planets, Planet.new(middleX, middleY, 0.0005, 0.029 * au, 0, 0, "plutonia", planets[9], "Titania"))
    table.insert(planets, Planet.new(middleX, middleY, 0.0004, 0.039 * au, 0, 0, "plutonia", planets[9], "Oberon"))
    table.insert(planets, Planet.new(middleX, middleY, 0.0004, 0.024 * au, 0, 0, "plutonia", planets[10], "Triton"))
    table.insert(planets, Planet.new(middleX, middleY, 0.00027, 0.005 * au, 0, 0, "plutonia", planets[11], "Charon"))
end
